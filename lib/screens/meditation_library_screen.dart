...
class _MeditationLibraryScreenState extends State<MeditationLibraryScreen> {
  ...
  static const List<GuidedAudioEpisode> _curatedEpisodes = [
    GuidedAudioEpisode(
      ...
      podcastTitle: 'Goodful',
      audioUrl: 'https://www.youtube.com/watch?v=inpok4MKVLM',
      durationMinutes: 5,
      description: 'Quick guided reset.',
      imageUrl: '',
    ),
    GuidedAudioEpisode(
      id: 'c2',
      title: '5 Minute Mindfulness Meditation',
      podcastTitle: 'The Honest Guys',
      audioUrl: 'https://www.youtube.com/watch?v=ssss7V1_eyA',
      durationMinutes: 5,
    ...
    GuidedAudioEpisode(
      ...
      podcastTitle: 'Great Meditation',
      audioUrl: 'https://www.youtube.com/watch?v=O-6f5wQXSu8',
      durationMinutes: 10,
      description: 'Calming session for anxiety.',
      imageUrl: '',
    ),
    GuidedAudioEpisode(
      id: 'c4',
      ...
      podcastTitle: 'Great Meditation',
      audioUrl: 'https://www.youtube.com/watch?v=ZToicYcHIOU',
      durationMinutes: 10,
      description: 'Morning reset.',
      imageUrl: '',
    ),
    GuidedAudioEpisode(
      id: 'c5',
      title: '20 Minute Deep Relaxation Meditation',
      podcastTitle: 'The Mindful Movement',
      audioUrl: 'https://www.youtube.com/watch?v=U6Ay9v7gK9w',
      durationMinutes: 20,
      description: 'Long-form relaxation.',
      imageUrl: '',
    ),
    GuidedAudioEpisode(
      id: 'c6',
      title: 'Sleep Meditation: Let Go of Overthinking',
      podcastTitle: 'Jason Stephenson',
      audioUrl: 'https://www.youtube.com/watch?v=aEqlQvczMJQ',
      durationMinutes: 20,
      description: 'Sleep wind-down.',
      imageUrl: '',
    ),
  ];
                    ...
                    Wrap(
                      ...
                      children: [5, 10, 20].map((minutes) {
                        ...
                        return ChoiceChip(
                          ...
                          selected: selected,
                          onSelected: (_) => setState(() => _selectedAudioDuration = minutes),
                          selectedColor: AppTheme.accentSoft,
                          labelStyle: GoogleFonts.inter(
                            color: selected ? AppTheme.accent : AppTheme.textSecondary,
                            fontWeight: FontWeight.w600,
                    ...
                    FutureBuilder<List<GuidedAudioEpisode>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final filtered = source.where((e) {
                          ...
                          if (_selectedAudioDuration == 10) {
                            return e.durationMinutes >= 8 && e.durationMinutes <= 14;
                          }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${episode.podcastTitle} • ${episode.durationMinutes} min',
            style: GoogleFonts.inter(fontSize: 12, color: AppTheme.textMuted),
          ),
          const SizedBox(height: 8),
          Align(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${session.durationMinutes} min - ${session.theme}',
                    style: GoogleFonts.inter(fontSize: 12, color: AppTheme.textMuted),
                  ),
                ],
              ),
